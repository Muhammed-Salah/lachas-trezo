        ...
        <div class="content" id="wrapper">
            <div class="container-fluid text-center" style="border-bottom: 1px solid #eee; padding: 10px 20px 10px;">
                ...
                <!--    <a href="javascript:void(0);" target="_blank" class="pull-left">
                        ...
                        <h3 style="display:inline" class="pull-center"><b>Lachas Trezò </b></h3>
                    </a>
                </span>
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="row answers">
                                                    ...
                                                    <div class="form-group">
                                                        <input class="form-control" type="text" name="answer" placeholder="Enter the answer here" required class="question_answer_2">
