...
<nav class="navbar navbar-default" role="navigation">
	<div class="container-fluid">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="page_q_.php"><h3><b>&nbsp;Crack & Win</b></h3></a>
		</div>
		<!-- menu items -->
...
<center><h3><font color='blue'><?php echo strtoupper("encrypt:<font color='red'>win</font>")  ?></h3></font>
	<h4>Hint:B=2,C=3</h4>


  <form action="fun/php.php" method='post'>
    
    <input type="number" name="b1" placeholder="Code" required>
...
<img src="../../img/s.png" height="100%" width="100%">
